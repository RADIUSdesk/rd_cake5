...
use Authentication\Identifier\IdentifierInterface; //--- This is used instead of PasswordIdentifier
use Authentication\Middleware\AuthenticationMiddleware;
use Cake\Routing\Router; //-- This is also used (but not in the CMS tutorial)
