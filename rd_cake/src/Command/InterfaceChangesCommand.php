...
use App\Model\Table\WanMwan3StatusTable;
use App\Model\Table\MwanInterfaceChangesTable;
...
class InterfaceChangesCommand extends Command {
    ...
    protected WanMwan3StatusTable $WanMwan3Status;
    protected MwanInterfaceChangesTable $MwanInterfaceChanges;
    protected ApsTable $Aps;
    protected NodesTable $Nodes;
    protected MwanInterfacesTable $MwanInterfaces;
    protected AlertsTable $Alerts;
    ...
    private function alertPlusEmail($intChange,$io){
        ...
        if($cloud_id){
            ...
            //print_r($email_list);
            if($email_list){
                $this->sendEmails($email_list,$change_info,$io);
            }                                                        
        }       
    ...
    private function sendEmails($email_list, $change_info,$io){
