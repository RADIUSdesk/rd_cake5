...
use App\Model\Table\AccelProfilesTable;
use App\Model\Table\AccelProfileEntriesTable;
...
class AccelProfilesController extends AppController{
    ...
    protected AccelProfilesTable $AccelProfiles;
    protected AccelProfileEntriesTable $AccelProfileEntries;
    
    public function initialize():void{  
        parent::initialize();
        
        $this->AccelProfiles        = $this->fetchTable('AccelProfiles');
        $this->AccelProfileEntries  = $this->fetchTable('AccelProfileEntries');
