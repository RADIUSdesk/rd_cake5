...
use App\Model\Table\AccelServersTable;
use App\Model\Table\AccelStatsTable;
use App\Model\Table\AccelSessionsTable;
use App\Model\Table\AccelArrivalsTable;
...
class AccelServersController extends AppController{
    ...
    protected AccelServersTable $AccelServers;
    protected AccelStatsTable $AccelStats;
    protected AccelSessionsTable $AccelSessions;
    protected AccelArrivalsTable $AccelArrivals;
    
    public function initialize():void{  
        parent::initialize();
        
        $this->AccelServers     = $this->fetchTable('AccelServers');
        $this->AccelStats       = $this->fetchTable('AccelStats');
        $this->AccelSessions    = $this->fetchTable('AccelSessions');
        $this->AccelArrivals    = $this->fetchTable('AccelArrivals');
