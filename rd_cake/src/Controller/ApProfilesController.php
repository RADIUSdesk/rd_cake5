...
use App\Model\Table\DynamicClientRealmsTable;
use App\Model\Table\RealmsTable;
use App\Model\Table\OpenvpnServersTable;
use App\Model\Table\OpenvpnServerClientsTable;
use App\Model\Table\ApProfileEntriesTable;
use App\Model\Table\ApProfileSettingsTable;
use App\Model\Table\ApProfileEntrySchedulesTable;
use App\Model\Table\ApApProfileEntriesTable;
use App\Model\Table\ApStaticEntryOverridesTable;
use App\Model\Table\NetworksTable;
use App\Model\Table\SitesTable;
use App\Model\Table\CloudsTable;
...
class ApProfilesController extends AppController {
    ...
    protected DynamicClientRealmsTable $DynamicClientRealms;
    protected RealmsTable $Realms;
    protected OpenvpnServersTable $OpenvpnServers;
    protected OpenvpnServerClientsTable $OpenvpnServerClients;
    protected ApProfileEntriesTable $ApProfileEntries;
    protected ApProfileSettingsTable $ApProfileSettings;
    protected ApProfileEntrySchedulesTable $ApProfileEntrySchedules;
    protected ApApProfileEntriesTable $ApApProfileEntries;
    protected ApStaticEntryOverridesTable $ApStaticEntryOverrides;
    protected NetworksTable $Networks;
    protected SitesTable $Sites;
    ...
    public function initialize():void
    {
        ...
        $this->DynamicClientRealms     = $this->fetchTable('DynamicClientRealms');
        $this->Realms                  = $this->fetchTable('Realms');
        $this->OpenvpnServers          = $this->fetchTable('OpenvpnServers');
        $this->OpenvpnServerClients    = $this->fetchTable('OpenvpnServerClients');
        $this->ApProfileEntries        = $this->fetchTable('ApProfileEntries');
        $this->ApProfileSettings       = $this->fetchTable('ApProfileSettings');
        $this->ApProfileEntrySchedules = $this->fetchTable('ApProfileEntrySchedules');
        $this->ApApProfileEntries      = $this->fetchTable('ApApProfileEntries');
        $this->ApStaticEntryOverrides  = $this->fetchTable('ApStaticEntryOverrides');
        $this->Networks                = $this->fetchTable('Networks');
    ...
    public function apProfileExitAdd(){
        ...
        if ($this->ApProfileExits->save($exitEntity)) {
            ...
            if($this->request->getData('type') == 'nat'){
                $this->ApProfileExitSettings      = $this->fetchTable('ApProfileExitSettings');
            ...
            if($this->request->getData('type') == 'pppoe_server'){
                $this->ApProfileExitPppoeServers      = $this->fetchTable('ApProfileExitPppoeServers');
                $d_ppp  = [
                   'ap_profile_exit_id' => $new_id,
    ...
    public function apProfileApIndex(){
        ...
        $ft_now         = DateTime::now();
        $ft_dead        = $ft_now->subSeconds($deadAfter);
    ...
    public function apProfileApAdd(){
        ...
        $this->OpenvpnServerClients    = $this->fetchTable('OpenvpnServerClients');
        $this->ApWifiSettings          = $this->fetchTable('ApWifiSettings');
        $this->ApConnectionSettings    = $this->fetchTable('ApConnectionSettings');
