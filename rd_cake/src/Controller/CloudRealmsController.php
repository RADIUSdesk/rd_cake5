...
use App\Model\Table\RealmAdminsTable;
...
class CloudRealmsController extends AppController {
    ...
    public function index(){
        ...
        if($node === 'root'){
            ...
            $query->orderBy(['Clouds.name' => 'ASC'])->contain(['Users','CloudAdmins.Users']); 	//Pull in the Users and Cloud Admins for clouds (root level)       	   	       	     	
