...
class AccelPppComponent extends Component {
	...
	public function initialize(array $config):void{
        $this->AccelProfiles= TableRegistry::getTableLocator()->get('AccelProfiles');
        $this->AccelServers = TableRegistry::getTableLocator()->get('AccelServers');
    }
    ...
    private function _addOrUpdate($info){    
        ...
        $info['config_fetched']         = DateTime::now();
