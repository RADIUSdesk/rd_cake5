...
class ApHelper22Component extends Component {
	...
	protected array $components 	= ['Firewall','MdFirewall','AccelPpp', 'Sqm','Connection', 'Passpoint','Vpn'];
    ...
    public function initialize(array $config):void{
        ...
        $this->UnknownAps       = TableRegistry::getTableLocator()->get('UnknownAps');
        $this->ApProfileSettings= TableRegistry::getTableLocator()->get('ApProfileSettings');
        $this->ApProfiles       = TableRegistry::getTableLocator()->get('ApProfiles');
        $this->OpenvpnServers   = TableRegistry::getTableLocator()->get('OpenvpnServers');
        $this->ApProfileEntries = TableRegistry::getTableLocator()->get('ApProfileEntries');
        $this->Hardwares        = TableRegistry::getTableLocator()->get('Hardwares'); 
        $this->UserSettings     = TableRegistry::getTableLocator()->get('UserSettings');
        $this->Timezones        = TableRegistry::getTableLocator()->get('Timezones');
        $this->OpenvpnServerClients   = TableRegistry::getTableLocator()->get('OpenvpnServerClients');
        $this->Devices          = TableRegistry::getTableLocator()->get('Devices');   
        
        $this->ApConnectionSettings     = TableRegistry::getTableLocator()->get('ApConnectionSettings');
        $this->PrivatePskEntries= TableRegistry::getTableLocator()->get('PrivatePskEntries');    
    }
    ...
    private function _update_fetched_info($ent_ap){
        ...
        $fetchedInfo['config_fetched'] = DateTime::now();
	...
	private function _checkForWbWReplacement(){ 
        ...
        if($ent_flag == true){
            $this->PasspointUplinks  = TableRegistry::getTableLocator()->get('PasspointUplinks');
    ...
    */
	...
	private function _scheduleStartDisabledTest($ap_profile,$schedules){
        ...
        $now    	= DateTime::now()->setTimezone($tz_name);
