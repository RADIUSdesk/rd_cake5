...
class MeshHelper22Component extends Component {
	...
	protected array $components = ['Firewall','MdFirewall','AccelPpp', 'Sqm','Connection'];
    ...
    public function initialize(array $config):void{
        ...
        $this->Meshes                   = TableRegistry::getTableLocator()->get('Meshes');
        $this->Nodes                    = TableRegistry::getTableLocator()->get('Nodes');
        $this->OpenvpnServers           = TableRegistry::getTableLocator()->get('OpenvpnServers');
        $this->NodeWifiSettings         = TableRegistry::getTableLocator()->get('NodeWifiSettings');
        $this->Devices                  = TableRegistry::getTableLocator()->get('Devices');
        $this->MeshExitSettings         = TableRegistry::getTableLocator()->get('MeshExitSettings');
        ...
        $this->NodeConnectionSettings   = TableRegistry::getTableLocator()->get('NodeConnectionSettings');
