...
class RdSmsComponent extends Component {
    ...
    protected array $components    = ['RdLogger'];
  
    public function initialize(array $config):void{
    
        $this->controller = $this->_registry->getController();
        $this->request    = $this->controller->getRequest();
        $this->UserSettings  = TableRegistry::getTableLocator()->get($this->main_model);
        $this->CloudSettings = TableRegistry::getTableLocator()->get($this->cloud_model); 
    }
