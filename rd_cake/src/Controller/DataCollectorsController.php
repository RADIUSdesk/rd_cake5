...
use App\Model\Table\DataCollectorsTable;
use App\Model\Table\DataCollectorOtpsTable;
...
class DataCollectorsController extends AppController{
    ...
    protected DataCollectorsTable $DataCollectors;
    protected DataCollectorOtpsTable $DataCollectorOtps;
            ...
            if($q_r->dynamic_detail->dynamic_detail_ctc->cust_info_check == true){
                ...
                if($dd_resuply_int == -1){
                    ...
                    $q_dd = $this->{$this->main_model}->find()
                        ...
                        ->orderBy([$this->main_model.'.modified' => 'DESC']) //Get the most recent one 
