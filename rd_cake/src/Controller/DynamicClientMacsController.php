...
use App\Model\Table\DynamicClientMacsTable;
use App\Model\Table\DynamicClientsTable;
use App\Model\Table\MacAliasesTable;
use App\Model\Table\ClientMacsTable;
...
class DynamicClientMacsController extends AppController {
	...
	protected DynamicClientMacsTable $DynamicClientMacs;
    protected DynamicClientsTable $DynamicClients;
    protected MacAliasesTable $MacAliases;
    protected ClientMacsTable $ClientMacs;
	
    public function initialize():void{
        parent::initialize();
        $this->DynamicClientMacs    = $this->fetchTable('DynamicClientMacs');
        $this->DynamicClients       = $this->fetchTable('DynamicClients');
        $this->MacAliases           = $this->fetchTable('MacAliases');
        $this->ClientMacs           = $this->fetchTable('ClientMacs');
