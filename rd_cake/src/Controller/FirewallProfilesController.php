...
use App\Model\Table\FirewallProfilesTable;
use App\Model\Table\UsersTable;
use App\Model\Table\FirewallProfileEntriesTable;
use App\Model\Table\FirewallProfileEntryFirewallAppsTable;

class FirewallProfilesController extends AppController {

    protected $main_model   = 'FirewallProfiles';
    protected FirewallProfilesTable $FirewallProfiles;
    protected UsersTable $Users;
    protected FirewallProfileEntriesTable $FirewallProfileEntries;
    protected FirewallProfileEntryFirewallAppsTable $FirewallProfileEntryFirewallApps;
    
    public function initialize():void{
        parent::initialize();
        
        $this->FirewallProfiles                  = $this->fetchTable('FirewallProfiles');
        $this->Users                             = $this->fetchTable('Users');
        $this->FirewallProfileEntries            = $this->fetchTable('FirewallProfileEntries');
        $this->FirewallProfileEntryFirewallApps  = $this->fetchTable('FirewallProfileEntryFirewallApps');
        ...
        if ($this->request->is('post')) {       
            ...
            if($req_data['action'] == 'limit'){       	      	
		   	...
		   	if($req_data['schedule'] == 'one_time'){			   	
		   		$req_data['one_time_date'] = new DateTime($req_data['one_time_date']." 00:00:00");			   	
		   	}
