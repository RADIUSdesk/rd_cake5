...
use App\Model\Table\FreeradiusStatsTable;
use App\Model\Table\FreeradiusInstancesTable;
...
class FreeradiusStatsController extends AppController{ 
    ...
    protected FreeradiusStatsTable $FreeradiusStats;
    protected FreeradiusInstancesTable $FreeradiusInstances;
    protected TimezonesTable $Timezones;
    

    public function initialize():void{  
        parent::initialize();
        $this->FreeradiusStats      = $this->fetchTable('FreeradiusStats');
        $this->FreeradiusInstances  = $this->fetchTable('FreeradiusInstances');
    ...
    private function _getInstances($ft_day,$span){
        ...
        ->orderBy(['FreeradiusInstances.modified DESC']) // The sort order is the opposite or VpnConnectionsController
        ->all(); 
