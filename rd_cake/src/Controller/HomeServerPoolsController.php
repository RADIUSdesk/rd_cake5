...
use App\Model\Table\HomeServerPoolsTable;
use App\Model\Table\HomeServersTable;
...
class HomeServerPoolsController extends AppController{
    ...
    protected HomeServerPoolsTable $HomeServerPools;
    protected HomeServersTable $HomeServers;
    protected NasTable $Nas;
    
    public function initialize():void{ 
        parent::initialize();
        
        $this->HomeServerPools    = $this->fetchTable('HomeServerPools');
        $this->HomeServers        = $this->fetchTable('HomeServers');
