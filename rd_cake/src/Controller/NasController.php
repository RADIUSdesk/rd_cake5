...
use App\Model\Table\NaSettingsTable;
use App\Model\Table\UserSettingsTable;
use App\Model\Table\NaStatesTable;
use App\Model\Table\NaRealmsTable;
...
class NasController extends AppController{
    ...
    protected NaSettingsTable $NaSettings;
    protected UserSettingsTable $UserSettings;
    protected NaStatesTable $NaStates;
    protected NaRealmsTable $NaRealms;
  
    public function initialize():void{  
        parent::initialize();
        $this->Nas           = $this->fetchTable('Nas');
        $this->Users         = $this->fetchTable('Users');
        $this->NaSettings    = $this->fetchTable('NaSettings');
        $this->UserSettings    = $this->fetchTable('UserSettings');
        $this->NaStates        = $this->fetchTable('NaStates');
        $this->NaRealms        = $this->fetchTable('NaRealms'); 
