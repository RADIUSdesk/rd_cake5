...
use App\Model\Table\PredefinedCommandsTable;
...
class NodeActionsController extends AppController {
    ...
    protected PredefinedCommandsTable $PredefinedCommands;
    ...
    public function initialize():void{
        ...
        $this->PredefinedCommands   = $this->fetchTable('PredefinedCommands');
