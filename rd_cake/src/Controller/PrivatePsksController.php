...
use App\Model\Table\PrivatePsksTable;
use App\Model\Table\PrivatePskEntriesTable;
...
class PrivatePsksController extends AppController{
    ...
    protected PrivatePsksTable $PrivatePsks;
    protected PrivatePskEntriesTable $PrivatePskEntries;

    
    public function initialize():void{ 
        parent::initialize();
        
        $this->PrivatePsks         = $this->fetchTable('PrivatePsks');
        $this->PrivatePskEntries   = $this->fetchTable('PrivatePskEntries');    
