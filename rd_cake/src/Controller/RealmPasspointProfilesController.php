...
use App\Model\Table\RealmPasspointProfilesTable;
use App\Model\Table\RealmPasspointNaiRealmsTable;
use App\Model\Table\RealmPasspointRcoisTable;

class RealmPasspointProfilesController extends AppController{
  
    protected $main_model   = 'RealmPasspointProfiles';
    
    protected RealmPasspointProfilesTable $RealmPasspointProfiles;
    protected RealmPasspointNaiRealmsTable $RealmPasspointNaiRealms;
    protected RealmPasspointRcoisTable $RealmPasspointRcois;
  
    public function initialize():void{  
        parent::initialize();
        $this->RealmPasspointProfiles     = $this->fetchTable('RealmPasspointProfiles');
        $this->RealmPasspointNaiRealms    = $this->fetchTable('RealmPasspointNaiRealms');
        $this->RealmPasspointRcois        = $this->fetchTable('RealmPasspointRcois');               
