...
use App\Model\Table\RealmSsidsTable;
use App\Model\Table\RealmPmksTable;
...
class RealmSsidsController extends AppController{
    ...
    protected RealmSsidsTable $RealmSsids;
    protected RealmPmksTable $RealmPmks;
  
    public function initialize():void{  
        parent::initialize();
        $this->Realms        = $this->fetchTable('Realms');
        $this->RealmSsids    = $this->fetchTable('RealmSsids');
        $this->RealmPmks     = $this->fetchTable('RealmPmks');
    ...
    public function index(){
       ...
       if($sort == 'realm_ssid_name'){
            $query->orderBy(['RealmSsids.name' => $dir]);
       }else{
            $query->orderBy(['RealmPmks.'.$sort => $dir]);
       }
