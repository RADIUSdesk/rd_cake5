...
use App\Model\Table\PermanentUserOtpsTable;
...
class RegisterUsersController extends AppController {
    ...
    protected PermanentUserOtpsTable $PermanentUserOtps;
    ...
    public function newPermanentUser(){
		...
		if(array_key_exists('login_page_id',$this->request->getData())){
		    ...
		    if($q_r->reg_rb_vlan === 'next_available'){
		        ...
		        $q_r_vlans = $this->{'RealmVlans'}->find()->where(['RealmVlans.realm_id' => $realm_id])->orderBy(['vlan' => 'ASC'])->all();
