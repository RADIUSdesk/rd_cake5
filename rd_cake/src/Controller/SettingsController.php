...
use App\Model\Table\CloudSettingsTable;
...
class SettingsController extends AppController{
    ...
    protected CloudSettingsTable $CloudSettings;
    ...
    public function initialize():void{  
        ...
        $this->CloudSettings     = $this->fetchTable('CloudSettings');
        $this->EmailHistories    = $this->fetchTable('EmailHistories');
        $this->SmsHistories      = $this->fetchTable('SmsHistories');
