...
use App\Model\Table\ApSqmStatsTable;
use App\Model\Table\ApsTable;
use App\Model\Table\NodeSqmStatsTable;
...
class SqmReportsController extends AppController {
    ...
    protected ApSqmStatsTable $ApSqmStats;
    protected ApsTable $Aps;
    protected NodeSqmStatsTable $NodeSqmStats;
    ...
    public function initialize():void{
        ...
        $this->ApSqmStats        = $this->fetchTable('ApSqmStats');
        $this->Aps               = $this->fetchTable('Aps');
        $this->NodeSqmStats      = $this->fetchTable('NodeSqmStats');
