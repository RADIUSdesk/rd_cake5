...
use App\Model\Table\ProfileFupComponentsTable;
...
class ThirdPartyRadiusController extends AppController {
	...
	protected string $main_model 	= 'Profiles';
	
	protected ProfilesTable $Profiles;
    protected ProfileComponentsTable $ProfileComponents;
    protected ProfileFupComponentsTable $ProfileFupComponents;
    ...
    public function initialize():void{
        ...
        $this->ProfileFupComponents  = $this->fetchTable('ProfileFupComponents');
