...
use App\Model\Table\ApVpnConnectionsTable;
use App\Model\Table\WireguardInstancesTable;
use App\Model\Table\ApsTable;
use App\Model\Table\ApProfileExitsTable;
use App\Model\Table\ApVpnConnectionApProfileExitsTable;
use App\Model\Table\ApVpnConnectionMacAddressesTable;
...
class VpnConnectionsController extends AppController{
    ...
    protected ApVpnConnectionsTable $ApVpnConnections;
    protected WireguardInstancesTable $WireguardInstances;
    protected ApsTable $Aps;
    protected ApProfileExitsTable $ApProfileExits;
    protected ApVpnConnectionApProfileExitsTable $ApVpnConnectionApProfileExits;
    protected ApVpnConnectionMacAddressesTable $ApVpnConnectionMacAddresses;
    protected MacAddressesTable $MacAddresses;
         
    public function initialize():void{  
        parent::initialize();
        $this->ApVpnConnections                 = $this->fetchTable('ApVpnConnections');
        $this->WireguardInstances               = $this->fetchTable('WireguardInstances');
        $this->Aps                              = $this->fetchTable('Aps');
        $this->ApProfileExits                   = $this->fetchTable('ApProfileExits');
        $this->ApVpnConnectionApProfileExits    = $this->fetchTable('ApVpnConnectionApProfileExits');
        $this->ApVpnConnectionMacAddresses      = $this->fetchTable('ApVpnConnectionMacAddresses');
	...
	public function apIndex(){
        ...
        $query 	= $this->ApVpnConnections->find()
                    ...
                    ->orderBy(['ApVpnConnections.name DESC']); // The sort order is the opposite or VpnReportsController
