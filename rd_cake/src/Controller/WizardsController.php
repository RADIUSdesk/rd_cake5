...
use App\Model\Table\DynamicPhotosTable;
...
use App\Model\Table\ProfileComponentsTable;
use App\Model\Table\RadusergroupsTable;
use App\Model\Table\RadgroupchecksTable;
use App\Model\Table\RadgrouprepliesTable;
...
use App\Model\Table\MeshExitMeshEntriesTable;
use App\Model\Table\MeshExitCaptivePortalsTable;
...
class WizardsController extends AppController{
    ...
    protected ProfileComponentsTable $ProfileComponents;
    protected RadusergroupsTable $Radusergroups;
    protected RadgroupchecksTable $Radgroupchecks;
    protected RadgrouprepliesTable $Radgroupreplies;
    ...
    protected MeshExitMeshEntriesTable $MeshExitMeshEntries;
    protected MeshExitCaptivePortalsTable $MeshExitCaptivePortals;
    ...
    public function initialize():void{  
        ...
        $this->ProfileComponents                 = $this->fetchTable('ProfileComponents');
        $this->Radusergroups                     = $this->fetchTable('Radusergroups');
        $this->Radgroupchecks                    = $this->fetchTable('Radgroupchecks');
        $this->Radgroupreplies                   = $this->fetchTable('Radgroupreplies');
        ...
        $this->MeshExitMeshEntries               = $this->fetchTable('MeshExitMeshEntries');
        $this->MeshExitCaptivePortals            = $this->fetchTable('MeshExitCaptivePortals');
