...
class PpskBehavior extends Behavior {
   ...
   public function beforeSave($event, $entity){
    ...
    private function _addNewEntries($realm_id,$ppsk){
        ...
        $realmSsids = TableRegistry::getTableLocator()->get('RealmSsids');
        $realmPmks  = TableRegistry::getTableLocator()->get('RealmPmks'); 
    ...
    private function _removeEntries($realm_id,$ppsk){
        $this->RealmPmks    = TableRegistry::getTableLocator()->get('RealmPmks');
