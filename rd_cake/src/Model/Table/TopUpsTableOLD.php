...
class TopUpsTable extends Table {
    ...
    private function _new_days_to_use($e,$entity){
        ...
        if($e->to_date == null){ //Looks fresh
            $old_value = null;
            $from_date = DateTime::now()->startOfDay();
            $to_date   = DateTime::now()->endOfDay();
            ...
            $e->to_date = DateTime::createFromTimestamp($updated_val)->endOfDay();
            $this->PermanentUsers->save($e);
        } 
